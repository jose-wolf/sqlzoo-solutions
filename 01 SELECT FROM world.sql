...
Q: Read the notes about this table. Observe the result of running this SQL command to show the name, continent and population of all countries. 
...
*/
	...
	SELECT name, gdp/population AS "capita gdp"
	FROM world
	WHERE population  >= 200000000;
...
*/
	...
	SELECT name, population/1000000 AS "population in million"
	FROM world
...
*/
	...
	SELECT name
	FROM world
	WHERE name NOT LIKE '% %' AND name ILIKE ALL (ARRAY['%a%','%e%','%i%','%o%','%u%']);